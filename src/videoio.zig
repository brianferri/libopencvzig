...
pub const VideoCapture = struct {
    ...
    pub fn set(self: *Self, prop: Properties, param: f64) c.OpenCVResult {
        return c.VideoCapture_Set(self.ptr, @intFromEnum(prop), param);
    }

    pub fn grab(self: Self, skip: i32) c.OpenCVResult {
        return c.VideoCapture_Grab(self.ptr, skip);
    }
